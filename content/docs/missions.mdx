...
### 3. Application Open
When ready, missions move to "Application Open" status.
...
Mission rewards vary based on:
- **Scope and complexity** — larger technical challenges earn more
- **Community impact** — broader benefit increases value
- **Quality requirements** — high-polish work is rewarded accordingly
- **Timeline urgency** — faster delivery may include bonuses

### Typical Ranges
- **Documentation missions**: $200-500
- **Tool/template creation**: $500-1,500  
- **Integration work**: $1,000-2,500
- **Infrastructure projects**: $1,500-3,000

*Actual rewards are specified per mission and may vary*
...
Join our Discord and ask in the #missions channel.
...
No, missions are open to all contributors. However, consistent contributors may be invited to join DAO governance.
