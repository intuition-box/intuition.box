...
interface DarkVeilProps extends ComponentPropsWithoutRef<'div'> {
  ...
  warpAmount?: number;
  /** Resolution scale factor (lower = better performance) */
  resolutionScale?: number;
}

/**
 * CPPN-generated dark organic WebGL background.
 * Neural-network-derived texture with optional scanlines, hue shift, and warp.
 *
